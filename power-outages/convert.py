...
with open(csv_file, mode='w', newline='') as file:
    ...
    for feature in features:
        ...
        attributes["timestamp"] = datetime.fromtimestamp(attributes.pop("TimeStamp") / 1000.0).strftime("%Y-%m-%d %H:%M:%S")
        ...
        attributes["edit_date"] = datetime.fromtimestamp(attributes.pop("EditDate") / 1000.0).strftime("%Y-%m-%d %H:%M:%S")
